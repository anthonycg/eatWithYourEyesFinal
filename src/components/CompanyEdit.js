...
const CompanyEdit = (props) => {
    ...
    return (
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            <div>
                <Link to={"/api/companies/"+ JSON.parse(sessionStorage.getItem("companyId")) }><button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
